...
\end{lemma}
\begin{proof}
Clearly the restriction of $\psi$ to $A^G \subset A$ induces an isomorphism, but we must verify that the image of this restriction actually equals $B^G$.  We check that 
\begin{align*}
...
\begin{cor}
If  $U, V, W$ are representations of $G$, then there are natural isomorphismis
\begin{enumerate}
