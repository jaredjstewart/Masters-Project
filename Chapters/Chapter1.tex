...
\end{note}
\begin{note}
Given any representation $\varphi$ of $G$ on a vector space $V$ over a field $F$ of dimension $n$, we can fix a basis for $V$ to obtain an isomorphism of vector spaces $\psi \colon V \to F^n$.   %Any n-dim reprn isomorphic to a reprn on GL_N(C) (teleman)
