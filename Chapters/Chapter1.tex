...
% ============== Examples of Representations ===========%
 \begin{example}
 \begin{enumerate}
\item Let $V$ be a $1$-dimensional vector space over the field $F$.  The map $\varphi \colon G \to GL(V)$ defined by $\varphi(g) = Id_V$ for all $g \in G$ is a representation called the \textit{trival representation} of $G$.  The trivial representation has dimension $1$.
