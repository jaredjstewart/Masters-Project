...
\begin{defn}
We can define a representation of $G$ on $V \bigotimes W$ called the \textbf{tensor product representation}. We define
\[ \varphi_{V \bigotimes W} (g) \colon V \bigotimes W \to V \bigotimes W \]
to be the linear map given by
\[ \varphi_{V \bigotimes W} (g) \colon a_i \bigotimes b_j \mapsto \varphi_V (g) (a_i) \bigotimes \varphi_W (g) (b_j).\]
\end{defn}
